...
function Experience() {
    ...
    const experience: string = `Soy desarrollador con experiencia en el desarrollo web utilizando Angular y React. Poseo sólidos conocimientos en la creación de REST APIs con .NET Core y NestJS, así como en el diseño y desarrollo de aplicaciones en tiempo real con Socket.IO y SignalR.
